...
export const Item = ({
    ...
    const onCreate = (
        ...
        .then((docummentId)=>{
            ...
            router.push(`/documents/${docummentId}`)
        });
    ...
    return (
        ...
        className={cn("group min-h[35px] text-sm py-1 pr-3 w-full hover:bg-primary/5 flex items-center text-muted-foreground font-medium",
                ...
                <div className="ml-auto flex items-center gap-x-2">
                  <DropdownMenu>
                    ...
                    >
                      ...
                      rounded-sm hover:bg-neutral-300 dark:hover:bg-[1F1F1F]  "
                      >
                  ...
                  onClick={onCreate}
                  className="opacity-0 group-hover:opacity-100 h-full ml-auto
                  rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-960"
                  >
